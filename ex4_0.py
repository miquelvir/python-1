...
"""
Ja has après tres coses de Python:

    1. El statement print per ensenyar missatges a l'usuari
    2. Com fer comentaris
    3. Variables per guardar informació
    4. Els texts sempre van entre cometes: ""

Are aprendràs a fer preguntes a l'usuari amb l'statement input.
"""

# això pregunta el nom a l'usuari i guarda la resposta a la variable name
name = input("what is your name? ")
print(name)  # com que hem guardat la resposta de l'usuari a la variable name, podem imprimir la resposta que hagi dit
